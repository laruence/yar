...
if (substr(PHP_OS, 0, 3) == 'WIN') die("skip the single-process php -S serves ~1 request per second on Windows CI, 128 concurrent calls cannot complete within the timeout");
?>
--FILE--
<?php 
include "yar.inc";
