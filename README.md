...
[![AppVeyor](https://ci.appveyor.com/api/projects/status/syhw33wlt2nad64i/branch/master?svg=true)](https://ci.appveyor.com/project/laruence/yar/branch/master) [![Linux](https://github.com/laruence/yar/actions/workflows/linux.yml/badge.svg?branch=master)](https://github.com/laruence/yar/actions/workflows/linux.yml) [![Windows](https://github.com/laruence/yar/actions/workflows/windows.yml/badge.svg?branch=master)](https://github.com/laruence/yar/actions/workflows/windows.yml)
...
| `yar.ssl_verify` | `Off` | Whether to verify the TLS certificate of HTTPS servers. When enabled, the curl transport sets `CURLOPT_SSL_VERIFYPEER` and `CURLOPT_SSL_VERIFYHOST`, and requests against servers with invalid certificates will fail. Disabled by default for backward compatibility. Available since 2.4.0. |
