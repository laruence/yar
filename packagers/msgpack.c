...
int php_hermes_packager_msgpack_pack(hermes_packager_t *self, zval *pzval, smart_str *buf, char **msg TSRMLS_DC) /* {{{ */ {
	php_msgpack_serialize(buf, pzval TSRMLS_CC);
	return 1;
} /* }}} */

zval * php_hermes_packager_msgpack_unpack(hermes_packager_t *self, char *content, size_t len, char **msg TSRMLS_DC) /* {{{ */ {
	zval *return_value;
...
hermes_packager_t hermes_packager_msgpack = {
	"MSGPACK",
	php_hermes_packager_msgpack_pack,
    php_hermes_packager_msgpack_unpack
};
