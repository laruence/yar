...
int php_hermes_packager_json_pack(hermes_packager_t *self, zval *pzval, smart_str *buf, char **msg TSRMLS_DC) /* {{{ */ {
...
zval * php_hermes_packager_json_unpack(hermes_packager_t *self, char *content, size_t len, char **msg TSRMLS_DC) /* {{{ */ {
	zval *return_value;
...
hermes_packager_t hermes_packager_json = {
	"JSON",
	php_hermes_packager_json_pack,
    php_hermes_packager_json_unpack
};
